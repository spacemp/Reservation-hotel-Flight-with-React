        ...
        {type !== "list" && (
          <>
            <h1 className="headerTitle">
              بهترین تجربه در کنار خانواده ؟ امتحان کنید.
            </h1>
            <p className="headerDesc">
              وقت و هزینه ای خود را مدیریت کنید . بهترین سرویس ها را از ما که
              سال ها تجربه داریم دریافت کنید .
            </p>
            ...
            <div className="headerSearch">
              <div className="headerSearchItem">
                ...
                <input
                  type="text"
                  placeholder="به کجا می خواهید سفر کنید؟"
